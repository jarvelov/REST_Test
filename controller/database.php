...
if( class_exists('SQLite3') ) {
    Class Database extends SQLite3 {
        ...
        private function fill() {
            $table_query = 'CREATE TABLE users IF NOT EXIST (
    ...
    var_dump('SQLite3 is not installed. Please refer to your distribution for install instructions! (Ubuntu: apt-get install php5-sqlite)');
}
 ?>